class UserMailer < ApplicationMailer
  ...
  def like_post
    return unless @user_to.setting.notification_on_like?
  ...
  def comment_post
    return unless @user_to.setting.notification_on_comment?
  ...
  def follow
    return unless @user_to.setting.notification_on_follow?
