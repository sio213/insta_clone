...
#                 new_mypage_creditcard GET    /mypage/creditcard/new(.:format)                                                         mypage/creditcards#new
#                edit_mypage_creditcard GET    /mypage/creditcard/edit(.:format)                                                        mypage/creditcards#edit
#                     mypage_creditcard PATCH  /mypage/creditcard(.:format)                                                             mypage/creditcards#update
#                                       PUT    /mypage/creditcard(.:format)                                                             mypage/creditcards#update
#                                       POST   /mypage/creditcard(.:format)                                                             mypage/creditcards#create
#                          mypage_plans GET    /mypage/plans(.:format)                                                                  mypage/plans#index
# mypage_contract_contract_cancellation POST   /mypage/contract/cancellation(.:format)                                                  mypage/contract/contract_cancellations#create
#                       mypage_contract POST   /mypage/contract(.:format)                                                               mypage/contracts#create
#                       mypage_payments GET    /mypage/payments(.:format)                                                               mypage/payments#index
...
Rails.application.routes.draw do
  ...
  namespace :mypage do
    ...
    resource :creditcard, only: [:new, :create, :edit, :update]
    resources :plans, only: [:index]
    resource :contract, only: [:create] do
