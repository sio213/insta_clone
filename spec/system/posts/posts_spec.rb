...
RSpec.describe 'ポスト', type: :system do
  ...
  describe 'ポスト一覧' do
    context 'ログインしている場合' do
      ...
      it 'フォローしている人と自分の投稿だけが表示されること' do
        visit posts_path
  ...
  describe 'ポスト投稿' do
    ...
    it '画像を投稿できること' do
      visit new_post_path
      within '#posts-form' do
        attach_file '画像', Rails.root.join('spec', 'fixtures', 'fixture.png')
        fill_in '内容', with: 'This is an example post'
        click_button '登録する'
      end
  ...
  describe 'ポスト更新' do
    ...
    it '投稿が更新できること' do
      ...
      within '#posts-form' do
        attach_file '画像', Rails.root.join('spec', 'fixtures', 'fixture.png')
        fill_in '内容', with: 'This is an example updated post'
        click_button '更新する'
      end
